...
public class CustomHopper extends StorageInventory {
    ...
    public CustomHopper(String name, String Storagetype, String PlayerUUID, Collection<String> PlayerFriends,BlockPos Pos, World world) {
