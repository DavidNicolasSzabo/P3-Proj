...
public class PlayerThread implements Runnable {
    ...
    public PlayerThread(String playerUUID, String playerName, RandomAccessFile fileName, boolean isServerRunning,Collection<PlayerThread> threads,ServerPlayerEntity player) {
    ...
    public void run() {
        ...
        synchronized (this) {
            try {
                ...
                server_mod.LOGGER.info("PlayerUUID: " + playerUUID);
