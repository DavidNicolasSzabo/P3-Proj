...
import net.da23335.CustomExcept;
import net.da23335.Item;
import net.da23335.StorageInventory;
import net.da23335.server_mod;
...
public class ShulkerBox extends StorageInventory {
    ...
    private Stacksize mapStackSize(int maxCount, String itemtype) throws CustomExcept {
        return switch (maxCount) {
            case 1 -> Stacksize.ONE;
            case 16 -> Stacksize.SIXTEEN;
            case 64 -> Stacksize.SIXTYFOUR;
